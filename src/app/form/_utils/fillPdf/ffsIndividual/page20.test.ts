...
import type { PdfFfsIndividualPage20 } from "@/app/form/_utils/fillPdf/ffsIndividual/page20";
...
describe("Page 20 - disclosure of ownership and control interest statement", () => {
  const testedPdfKeys = new Set<keyof PdfFfsIndividualPage20>([]);
