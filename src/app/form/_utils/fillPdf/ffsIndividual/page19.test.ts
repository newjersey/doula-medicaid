...
import type { PdfFfsIndividualPage19 } from "@/app/form/_utils/fillPdf/ffsIndividual/page19";
...
describe("Page 19 - disclosure of ownership and control interest statement", () => {
  const testedPdfKeys = new Set<keyof PdfFfsIndividualPage19>([]);
