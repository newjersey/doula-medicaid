...
const FormSection = () => {
  ...
  const {
    ...
    defaultValues: {
      trainingStreetAddress1: getValue("streetAddress1") || "",
      trainingStreetAddress2: getValue("streetAddress2") || "",
      trainingCity: getValue("city") || "",
      trainingState: getValue("state") || "NJ",
      trainingZip: getValue("zip") || "",
      ...
      <Form onSubmit={handleSubmit(onSubmit, onError)} className="maxw-full" noValidate>
        ...
        >
          ...
          {errors.doulaTrainingInPerson && (
            <span id="doulaTrainingInPersonErrorMessage" className="usa-error-message" role="alert">
