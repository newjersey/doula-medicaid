...
export const WelcomeFaq = (props: { headingLevel: HeadingLevel }) => {
  const faqContent: AccordionItemProps[] = [
    ...
    },
    {
      ...
      content: (
        <ol>
          ...
          <li>
            Navigate to the Taxonomy page, and in the Taxonomy Filter box, enter the code
            374J00000X.
          </li>
      ...
      content: (
        <>
          <p>
            ...
            <span className="text-bold">Sole Proprietorship business type</span> is a common
    ...
    },
    {
      ...
      content: (
        <p>
          We encourage you to connect with your training organization so they can recommend
          available doula insurances.
        </p>
      ),
      expanded: false,
    ...
    },
    {
      ...
      content: (
        <p>
          You need active doula liability insurance. This insurance must not expire within 3 months
          of your FFS application submission and must have a minimum coverage of $1 million per
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            Your FFS application will NOT be sent to MCOs automatically; you&apos;ll need to
            complete their applications separately, which you can do visiting the{" "}
            <a
      ...
      content: (
        <>
          <p>
            ...
            Provider Identifier), your contact and NPI details will be listed on the national
            National Plan and Provider Enumeration System (NPPES) NPI Registry. If you use your home
            address as your mailing and/or business address, it will be public.
          </p>
          <p>
            NJ FamilyCare doesn&apos;t control NPPES listings. Once enrolled, you&apos;ll also
            appear on the NJ FamilyCare FFS Provider Directory (
            <a
