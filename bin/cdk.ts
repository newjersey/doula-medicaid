...
/**
 * AWS CDK Application Entry Point for Doula Assistant Service
 *
 ...
 * instantiates the Doula Assistant stack with appropriate configuration for different
 * environments.
 *
...
/**
 * Doula Assistant Service Infrastructure Stack
 *
 * Deploys a complete, production-ready infrastructure for the Doula Assistant service including:
 *
 ...
 */
new CdkStack(app, "DoulaAssistantStack", {
  /**
   ...
   * resource management.
   */
  description: "Infrastructure for Doula Assistant Service - includes ALB and ECS",
   ...
   */
  tags: {
    Project: "DoulaAssistantFargateService",
